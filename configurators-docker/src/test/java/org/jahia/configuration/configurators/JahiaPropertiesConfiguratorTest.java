...
//        try (FileInputStream inStream = new FileInputStream(jahiaDefaultConfigFileParentPath + "jahia.properties")) {
...
//        try (FileInputStream inStream = new FileInputStream(secondTargetJahiaPropertiesFile)) {
